    ...
    : Component("4081Component", 14)
{
    ...
    this->pins[3] = cAnd2->getPin(1);
    this->pins[4] = cAnd2->getPin(2);
    this->pins[5] = cAnd2->getPin(3);
    this->pins[6]->type = PinType::ELECTRICAL;
    this->pins[7] = cAnd3->getPin(1);
    this->pins[8] = cAnd3->getPin(2);
    this->pins[9] = cAnd3->getPin(3);
    this->pins[10] = cAnd4->getPin(1);
    this->pins[11] = cAnd4->getPin(2);
    this->pins[12] = cAnd4->getPin(3);
